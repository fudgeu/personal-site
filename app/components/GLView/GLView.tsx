...
void main(void) {
  ...
  PointLight purpleLight = PointLight(vec3(-5.0, -5.0, 5.0), vec3(0, 0, 0), vec3(0.59, 0, 1), 1.0, 0.3, 0.08);
  PointLight blueLight = PointLight(vec3(5.0, 5.0, 5.0), vec3(0, 0, 0), vec3(0, 0.14, 0.37), 1.0, 0.3, 0.16);
