export default function initShaderProgram(gl: WebGLRenderingContext, vertexSource: string, fragmentSource: string): WebGLProgram | null {
  ...
  const shaderProgram = gl.createProgram() // create shader program, consists of both vertex and fragment shaders
